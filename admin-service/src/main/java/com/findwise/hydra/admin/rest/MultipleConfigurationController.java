...
public class MultipleConfigurationController {
	...
	@ResponseBody
	public Map<String, Object> addLibrary(@PathVariable String pipelineName, @PathVariable String id, @RequestParam MultipartFile file) throws IOException {
	...
	public Map<String,List<Stage>> getStages(@PathVariable String pipelineName) {
